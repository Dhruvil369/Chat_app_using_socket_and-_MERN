...
import { MessageSquare,User,Eye,Mail,Lock,EyeOff,Loader2 } from "lucide-react";
...
export default function Signuppage() {
  ...
  const validateForm =()=>{
    ...
    if(formData.password.length<6) return toast.error("Passwrod must be greater then 6 character");
